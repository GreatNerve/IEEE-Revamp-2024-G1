...
export default function Banner() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-5 mx-auto max-w-screen-xl px-4 py-4 pt-24 sm:px-6 lg:min-h-screen  lg:px-8">
        <div className="lg:flex lg:items-center">
          <div className="max-w-2xl text-left ltr:sm:text-left rtl:sm:text-right">
            <h1 className="tracking-tight	 text-3xl font-extrabold sm:text-5xl">
              ...
              <strong className="block tracking-wide text-7xl font-extrabold text-blue-700">
                {" "}
                IEEE{" "}
              </strong>
            </h1>
            ...
            <p className="mt-4 max-w-lg sm:text-xl/relaxed">
              Sparking with the passion of technology, we are the IEEE NSUT
              Student Branch. We are a group of technology enthusiasts who are
