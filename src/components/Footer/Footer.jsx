...
const Footer = () => {
    return (
        ...
        < footer className="bg-white dark:bg-blue-950/20 mt-4 md:mt-8" >
            <div className="mx-auto max-w-screen-xl px-4 py-4 md:pt-6 sm:px-6 lg:px-8">
                <div
                    className="flex flex-col items-center gap-4 rounded-lg bg-blue-600 p-6 shadow-lg sm:flex-row sm:justify-between"
                >
                    <strong className="text-xl text-white sm:text-xl">
                        Join our WhatsApp group to stay updated with the latest news and events.
                    </strong>
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            ...
                            <p className="mt-4 max-w-xs text-gray-500 dark:text-gray-400">
                                IEEE NSUT always strive for excellence and provide the best networking opportunities to its members.
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-2 lg:grid-cols-3">
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">IEE Chapters in NSUT</p>
                            ...
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">IEEE Resouces</p>
